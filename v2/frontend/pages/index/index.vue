    ...
    <scroll-view scroll-y class="list" v-else>
      ...
      <view v-for="m in fixtures" :key="m.id" class="card" @click="openDetail(m)">
        <view class="meta">
          ...
          <text class="status">
            {{ m.status.text }}<text v-if="m.status.minute"> {{ m.status.minute }}'</text>
          </text>
        </view>
        ...
        <view class="teams">
          ...
          <view class="score">
            <text class="s">{{ m.score.home === null || m.score.home === undefined ? "-" : m.score.home }}</text>
            <text class="dash">:</text>
            <text class="s">{{ m.score.away === null || m.score.away === undefined ? "-" : m.score.away }}</text>
          </view>
